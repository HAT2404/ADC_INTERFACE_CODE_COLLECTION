...
HD_PWD='D:/GitHub_FPGA/ADC_INTERFACE_CODE_COLLECTION/AD7606/Serial/Read_AD7606_Serial_XC7A15T/Read_AD7606_Serial_XC7A15T.runs/Module_top_clk_wiz_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Module_top_clk_wiz_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Module_top_clk_wiz_0_0.tcl
