...
HD_PWD='D:/GitHub_FPGA/AD7606/Parallel/Read_AD7606_Parallel_XC7A15T/Read_AD7606_Parallel_XC7A15T.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Module_top_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Module_top_wrapper.tcl -notrace
