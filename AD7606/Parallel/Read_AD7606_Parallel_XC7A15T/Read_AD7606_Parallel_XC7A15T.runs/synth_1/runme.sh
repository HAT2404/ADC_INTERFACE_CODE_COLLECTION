...
HD_PWD='D:/GitHub_FPGA/AD7606/Parallel/Read_AD7606_Parallel_XC7A15T/Read_AD7606_Parallel_XC7A15T.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Module_top_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Module_top_wrapper.tcl
